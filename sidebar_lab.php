...
<center><img src="img/lab7.jpg" class="" style="height:180px;width:285px;text-align:center;"/></center>
<h4>Lab Technician <?php echo $user; ?></h4>
</div>
...
<li class="list-group-item"><a href="success_lab.php?add"><i class="fa fa-edit"></i>&nbsp;&nbsp;Update Used chemicals</a></li>